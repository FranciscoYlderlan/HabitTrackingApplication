...
export function NewHabitForm() {
    ...
    return (
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6 ">
                        ...
                        return (
                            ...
                            >
                                <div
                                    ...
                                    justify-center bg-zinc-900 border-zinc-800 group-data-[state=checked]:bg-green-500
            ...
            rounded-lg p-4 gap-3 font-semibold bg-green-600
            hover:bg-green-500 transition-colors focus:outline-none focus:ring-2 
            focus:ring-violet-600 focus:ring-offset-2 focus:ring-offset-zinc-900 ">
